...
import net.techcn.solarricerakeapp.BluetoothTools.BluetoothUtil;
...
//            Log.d("ConnectedFragment", "connectedFragment != null: remove");
//            getParentFragmentManager().beginTransaction()
//                    .remove(connectedFragment)
//                    .commit();
//            getParentFragmentManager().popBackStack();
//        }

//        Fragment newFragment = new ConnectedFragment();
//        newFragment.setArguments(args);
//        getParentFragmentManager().beginTransaction()
//                .add(R.id.fragment1, newFragment, "connectedActivity")
//                .addToBackStack(null)
//                .commit();

        Fragment fragment = new ConnectedFragment();
        fragment.setArguments(args);
        getParentFragmentManager().beginTransaction().add(R.id.fragment1, fragment, "connectedAcitivity").addToBackStack(null).commit();
    }
}
