...
import net.techcn.solarricerakeapp.databinding.FragmentMoistureHistoryBinding;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class MoistureHistoryFragment extends Fragment {

    FragmentMoistureHistoryBinding binding;
    GlobalObject globalObject;
    public static final String  LOG_TAG = MoistureHistoryFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMoistureHistoryBinding.inflate(inflater, container, false);
    ...
    private void populate_table() {
        ...
        progressDialog.show();
        try {
            List<MoistureHistoryModel> dataObjectList = new ArrayList<>();
            globalObject.moistureRef.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        for (DataSnapshot childSnapshot : childSnapshots) {
                            ...
                            dataObjectList.add(new MoistureHistoryModel(description, timestamp, value));
                        }

                        RecyclerView recyclerView = binding.tableRecyclerView;
                        MoistureHistoryTableAdapter adapter = new MoistureHistoryTableAdapter(dataObjectList);
